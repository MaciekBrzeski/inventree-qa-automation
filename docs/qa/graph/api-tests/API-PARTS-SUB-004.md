---
title: "API-PARTS-SUB-004 PATCH /api/bom/substitute/{id}/ updates the substitute"
side: api
spec: parts-bom-substitute
file: submission/automation/api/tests/parts-bom-substitute.spec.ts
case-ids: [API-PARTS-SUB-004]
endpoints-hit: 1
...
- [[patch-api-bom-substitute-id|PATCH /api/bom/substitute/{id}/]]
