---
title: "UI-ATTR-001 flip assembly flag via UI edit modal → PATCH /api/part/{id}/"
side: ui
spec: f-parts-attributes
file: submission/automation/ui/tests/f-parts-attributes.spec.ts
case-ids: [UI-ATTR-001]
endpoints-hit: 5
...
- Side: **UI**
- Spec file: [`submission/automation/ui/tests/f-parts-attributes.spec.ts`](https://github.com/MaciekBrzeski/inventree-qa-automation/blob/main/automation/ui/tests/f-parts-attributes.spec.ts)
- Case IDs: [[UI-ATTR-001]]
