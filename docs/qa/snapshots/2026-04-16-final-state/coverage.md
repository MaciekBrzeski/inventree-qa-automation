...
Generated: 2026-04-16T14:45:16.092Z

## Summary

- OpenAPI endpoints in scope: **83**
- Covered by at least one UI test: **50**
- Uncovered: **33**
...
| `GET /api/part/{id}/` | 65 |
| `GET /api/part/{id}/bom-validate/` | 12 |
| `GET /api/part/{id}/pricing/` | 10 |
| `GET /api/part/{id}/requirements/` | 65 |
| `GET /api/part/{id}/serial-numbers/` | 65 |
| `PATCH /api/bom/{id}/` | 1 |
